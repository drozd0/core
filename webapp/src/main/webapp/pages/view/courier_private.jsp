...
<h1>Courier private account</h1>
<a href="/courier">Назад</a>
<a href="/logout">Выйти</a></td>

<h3>${currentUser.username} - courier</h3>
<form:form commandName="phoneSaveRequest" method="post" action="/courier/personal/phonesave">
...
<form:form commandName="addressSaveRequest" method="post" action="/courier/personal/addresssave">
    <input type="hidden" name="email" value="${currentUser.username}"/>
...
<form:form commandName="purseSaveRequest" method="post" action="/courier/personal/pursesave">
    <input type="hidden" name="email" value="${currentUser.username}"/>
    <table>
